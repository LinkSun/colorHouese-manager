    ...
    <div>
        ...
        <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="赠送1:">
                ...
                签到成功可得
                <el-input v-model="form.purchase_return"  class="area"></el-input>饭票
            ...
            <el-form-item label="增送2:">
                ...
                推荐成功可得
                <el-input v-model="form.sign_return" class="area"></el-input>饭票
        ...
        getMount() {
            ...
            httpClient
                ...
                .then(res => {
                    ...
                    this.form.buy_send = res.content.f_ticket;
                    this.form.recommend_send = res.content.rebate;
                    this.form.purchase_return = res.content.purchase_return;
                    this.form.buy_describe = res.content.f_ticket_describe;
                    this.form.recommend_describe = res.content.rebate_describe;
        ...
        onSubmit() {
            ...
            httpClient
                .post('admin/add/reward', {
                    bid: this.form.bid,
                    buy_send: this.form.f_ticket,
                    recommend_send: this.form.rebate,
                    purchase_return: this.form.purchase_return,
                    buy_describe: this.form.f_ticket_describe,
                    recommend_describe: this.form.rebate_describe,
