        ...
        <el-dialog title="编辑轮播图" :visible.sync="dialogFormUpdateVisible" width="50%">
            <el-form ref="form" :model="formUpdate" label-width="100px">
                ...
                <el-form-item label="上传新图片:" required>
                    ...
                    <el-upload action="https://salesv2-ccw-test.colourlife.com/upload/image/450" list-type="picture-card" :limit="1" :on-exceed="handleExceed" :auto-upload="true" name="photo" :on-success="mySuccess">
...
export default {
  ...
  methods: {
    ...
    mySuccess(res) {
      ...
      console.log(res)
      this.formUpdate.image= res.content.photoPath
    },
